      ...
      try {
        ...
        if (data.success == true) {
          ...
          await dotask(
            ll1taskType,
            ll1signtaskid,
            'https://prodev.m.jd.com/jdlite/active/4SuoxWhFFp5P8SpYoMm6iFuFrXxC/index.html'
          );
          ...
          await dotask(
            ll1taskType,
            ll1signtaskid,
            'https://pro.m.jd.com/jdlite/active/BMvPWMK1RsN4PWh1JksQUnRCxPy/index.html'
          );
          await apTaskDrawAward(
            ll1taskType,
            ll1signtaskid,
          ...
          await dotask(
            ll1taskType,
            ll1signtaskid,
            'https://pro.m.jd.com/jdlite/active/3H885vA4sQj6ctYzzPVix4iiYN2P/index.html'
          );
          await apTaskDrawAward(
            ll1taskType,
            ll1signtaskid,
          ...
          await dotask(
            ll1taskType,
            ll1signtaskid,
            'https://pro.m.jd.com/jdlite/active/vN4YuYXS1mPse7yeVPRq4TNvCMR/index.html'
          );
          await apTaskDrawAward(
            ll1taskType,
            ll1signtaskid,
          ...
          await dotask(
            ll1taskType,
            ll1signtaskid,
            'https://pro.m.jd.com/jdlite/active/4AMo3SQzbqAzJgowhXqvt8Dpo8iA/index.html'
          );
          await apTaskDrawAward(
            ll1taskType,
            ll1signtaskid,
