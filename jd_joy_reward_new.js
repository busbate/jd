...
[task_local]
#宠汪汪积分兑换奖品
0 0-16/8 * * * jd_joy_reward_new.js, tag=宠汪汪积分兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon==============
[Script]
cron "0 0-16/8 * * *" script-path=jd_joy_reward_new.js,tag=宠汪汪积分兑换奖品

================Surge===============
宠汪汪积分兑换奖品 = type=cron,cronexp="0 0-16/8 * * *",wake-system=1,timeout=3600,script-path=jd_joy_reward_new.js

===============小火箭==========
宠汪汪积分兑换奖品 = type=cron,script-path=jd_joy_reward_new.js, cronexpr="0 0-16/8 * * *", timeout=3600, enable=true
*/
